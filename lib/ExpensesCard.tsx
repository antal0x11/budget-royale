...
export default function ExpensesCard(props : ExpensesCardProps) {
	...
	function deleteCard() {
		updateData({type : "updateData/deleteExpense"}, null, props);
	}

	return (
		<div className={styles.card}>
			<div className={styles.item}>{props.date}</div>
			<div className={styles.item}>{props.title} {props.cost + "$"}</div>
			{props.comments?.length &&
				<div className={styles.item}>Comments: {props.comments}</div>
			}
			<div className={styles.deleteItem} onClick={deleteCard}>
